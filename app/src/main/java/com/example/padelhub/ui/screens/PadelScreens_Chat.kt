...
@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun ScreenConfigurarTelefonoPrimero(navController: NavController) {
    Scaffold(
        bottomBar = { BottomNavigation(navController) }
    ) {
        ContenidoAppChat()
...
@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun ScreenConfigurarTelefonoSegundo(navController: NavController) {
    Scaffold(
        bottomBar = { BottomNavigation(navController) }
    ) {
        ContenidoAppChat()
...
@Composable
fun ContenidoConfigurarTelefonoPrimero(navController: NavController, auth: FirebaseAuth) {
    var telefono by remember { mutableStateOf(value = "") }
    val context = LocalContext.current
    val countryCodePicker: CountryCodePicker=findViewById
    val phoneInput: EditText
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column(
            ...
            CustomOutlinedTextField(value = telefono, onValueChange = {telefono = it}, label = "telefono")
